...
get_memory_model(const optionst &options, const namespacet &ns,abstract_goto_modelt& goto_model)
{
  load_memory_model();
  ...
  )
{
  ...
  if(equation.has_threads())
  {
    std::unique_ptr<memory_model_baset> memory_model =
      get_memory_model(options, ns,goto_model);

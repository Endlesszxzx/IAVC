...
protected:
  ...
  typedef std::map<event_it, clock_t> numberingt;
  ...
  virtual symbol_exprt clock(event_it e, axiomt axiom);
  ...
  std::string show_event(event_it it);
};
